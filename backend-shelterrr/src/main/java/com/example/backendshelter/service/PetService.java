...
import com.example.backendshelter.exception.PetNotFoundException;
...
public class PetService {
    ...
    public List<Pet> save(List<CreatePetRQ> createPetRQList) throws PetNotFoundException {
    ...
    public Pet findById(Long id) {
        return petRepository.findById(id).orElseThrow(() -> new PetNotFoundException("Pet doesn't exists."));
    }
